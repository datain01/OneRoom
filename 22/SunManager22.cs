    ...
    void UpdateWeatherEffect()
    {
        ...
        switch (currentWeather)
        {
            ...
            case WeatherState.Snow:
                ...
                break;
            case WeatherState.Cloudy:
                skyEffect.sprite = null; // Cloudy 상태에서는 효과 제거
                break;
            case WeatherState.Normal:
            default:
                skyEffect.sprite = null; // Normal 상태에서도 효과 제거
                break;
        }
    }
