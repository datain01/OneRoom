...
public class SunManager8 : MonoBehaviour
{
    ...
    private Color noonColor = new Color(1.0f, 0.95f, 0.98f); // 옅은 핑크색 (하얀색에 가깝게)
    private Color sunsetColor = new Color(1.0f, 0.5f, 0.5f); // 핑크빛이 도는 붉은색
